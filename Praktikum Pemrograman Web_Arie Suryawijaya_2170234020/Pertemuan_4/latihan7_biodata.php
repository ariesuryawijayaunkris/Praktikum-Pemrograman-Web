...
<body>
    ...
    echo "<h1>BIODATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Arie Suryawijaya'></td></tr>";
    ...
    echo "<tr><td class='atas'>Foto :</td><td><img src='arie.png' width='200px'></img></td></tr>";
